...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../NavRushSDK-iOS/Libs/NavRushFramework.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NavRushSDK-iOS/NavRushSDK_iOS.framework"
